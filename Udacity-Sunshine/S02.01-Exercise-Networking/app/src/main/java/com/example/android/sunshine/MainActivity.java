...
//        }
    ...
    private void loadWeatherData() {
        ...
        new NetworkRequest().equals(location) ;
    }
    ...
    public class NetworkRequest extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL mWeatherRequestURL = NetworkUtils.buildUrl(location);

            try {

                String mJsonWeatherResponce = NetworkUtils.getResponseFromHttpUrl(mWeatherRequestURL);
                String [] mSimpleJsonWeatherdata = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, mJsonWeatherResponce);
                return mSimpleJsonWeatherdata ;
        ...
        protected void onPostExecute(String[] weatherData) {
            if(weatherData != null) {
                for (String mWeatherData : weatherData) {
                    mWeatherTextView.append((mWeatherData) + "\n\n\n") ;
                }
            }
        }
    }
